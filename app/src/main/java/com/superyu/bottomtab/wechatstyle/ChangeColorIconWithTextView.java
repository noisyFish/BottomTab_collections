...
public class ChangeColorIconWithTextView extends View
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		int top = (getMeasuredHeight()-mIconBitmap.getHeight())/2;
		// 设置icon的绘制范围
		mIconRect = new Rect(left, top/2, left + mIconBitmap.getWidth(), top + mIconBitmap.getHeight()-15);
	...
	{
		mTextPaint.setTextSize(mTextSize);
		mTextPaint.setColor(0xff7a7a7e);
		mTextPaint.setAlpha(255 - alpha);
		canvas.drawText(mText, mIconRect.left + mIconRect.width() / 2
						- mTextBound.width() / 2,
				mIconRect.bottom + mTextBound.height()+10, mTextPaint);
	}
